...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toolButton.setGeometry(QtCore.QRect(160, 110, 61, 31))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../icon/zongjiao.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton.setText(_translate("Form", "工具"))
